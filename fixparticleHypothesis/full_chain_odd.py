...
actsDir = pathlib.Path("/eos/user/r/reyu/software/acts")
...
if args.edm4hep:
    ...
    if not args.ttbar:
        addParticleGun(
            ...
            ParticleConfig(
                args.gun_particles, acts.PdgParticle.eProton, randomizeCharge=True
            ),
...
#        logLevel=acts.logging.VERBOSE,
 ...
 #           outputDirRoot=outputDir if args.output_root else None,
    ...
    addVertexFitting(
        ...
        seeder=acts.examples.VertexSeedFinder.TruthSeeder,
        useTime=True,
